...
export const buildPasswordResetEmail = ({
  ...
  const bodyHtml = `
    ...
    <p style="margin:24px 0 8px 0;font-size:13px;color:#6F665B;line-height:1.6;">
      If the button doesn't open, copy and paste this URL into your browser:
    </p>
    <p style="margin:0;font-size:12px;word-break:break-all;color:#0B5A43;">
      <a href="${escapeHtml(resetUrl)}" style="color:#0B5A43;">${escapeHtml(resetUrl)}</a>
    </p>`
